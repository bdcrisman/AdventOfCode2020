...
namespace Day2
{
    class Program
    {
        ...
        {
            var numValidPasswordsPartOne = new PartOne().CheckHowManyPasswordsAreValid(PuzzleInput);
            var numValidPasswordsPartTwo = new PartTwo().CheckHowManyPasswordsAreValidAgain(PuzzleInput);
            Console.WriteLine($"Part 1: num correct passwords: {numValidPasswordsPartOne}");
            Console.WriteLine($"Part 2: num correct passwords: {numValidPasswordsPartTwo}");
        }
    }
}
